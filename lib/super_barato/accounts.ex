defmodule SuperBarato.Accounts do
  @moduledoc """
  ...
  alias SuperBarato.Accounts.{User, UserToken, UserNotifier}
  ...
  See `SuperBarato.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `SuperBarato.Accounts.User.password_changeset/3` for a list of supported options.
